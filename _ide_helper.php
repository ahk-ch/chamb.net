...
namespace {
    ...
    class Flash extends \App\Ahk\Notifications\Flash{
        ...
        public static function success($message){
            return \App\Ahk\Notifications\FlashNotifier::success($message);
        }
        ...
        public static function message($message, $level = 'info'){
            return \App\Ahk\Notifications\FlashNotifier::message($message, $level);
        }
        ...
        public static function error($message){
            return \App\Ahk\Notifications\FlashNotifier::error($message);
        }
