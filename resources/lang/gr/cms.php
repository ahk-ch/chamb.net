...
return [
	...
	|--------------------------------------------------------------------------
	|
	| The following language lines are used during the administration panel rendering.
	|
	*/
	...
	'name'                             => 'Όνομα',
	'name_of_contact_partner'          => 'Όνομα του Συνεργάτη Επικοινωνίας',
	'sign_out'                         => 'Αποσύνδεση',
	...
	'unable_to_attach_tags'            => 'Δεν ήταν δυνατή η επισυνάψη ετικετών.',
